...
class mirna_profile(models.Model):
    mirna_id = models.CharField(max_length=45,null=True)
    acc = models.FloatField(null=True)
    blca = models.FloatField(null=True)
    brca = models.FloatField(null=True)
    cesc = models.FloatField(null=True)
    coad = models.FloatField(null=True)
    dlbc = models.FloatField(null=True)
    esca = models.FloatField(null=True)
    hnsc = models.FloatField(null=True)
    kich = models.FloatField(null=True)
    kirc = models.FloatField(null=True)
    kirp = models.FloatField(null=True)
    laml = models.FloatField(null=True)
    lgg = models.FloatField(null=True)
    lihc = models.FloatField(null=True)
    luad = models.FloatField(null=True)
    lusc = models.FloatField(null=True)
    meso = models.FloatField(null=True)
    ov = models.FloatField(null=True)
    paad = models.FloatField(null=True)
    pcpg = models.FloatField(null=True)
    prad = models.FloatField(null=True)
    reada = models.FloatField(null=True)
    sarc = models.FloatField(null=True)
    skcm = models.FloatField(null=True)
    stad = models.FloatField(null=True)
    thca = models.FloatField(null=True)
    ucec = models.FloatField(null=True)
    ucs = models.FloatField(null=True)
    mirna_info = models.OneToOneField(mirna_info)
...
class repeat_conservation(models.Model):
    ...
    repeat = models.CharField(max_length=225, null=True)
    chimpanzee = models.CharField(max_length=225, null=True)
    rhesus = models.CharField(max_length=225, null=True)
    mouse = models.CharField(max_length=225, null=True)
